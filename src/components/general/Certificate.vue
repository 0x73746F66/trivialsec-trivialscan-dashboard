<template>
    <div class="font-color-light font-base">
        <div class="row margin-bottom-sm">
            ...
            <div class="d-flex col-12 col-lg-6 expiry-text">
                <span v-if="expired" class="font-color-danger w-100">{{
                    expiry_status
                }}</span>
                <span v-else class="font-color-primary w-100">{{
                    expiry_status
                }}</span>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-lg-6 d-flex flex-column">
                <span
                    class="font-color-light margin-bottom-xxs"
                    v-if="not_before"
                >
                ...
                <span
                    class="font-color-light margin-bottom-xxs"
                    v-if="authority_key_identifier"
                >
                    <div class="font-base-sb">
                        Authority Key Identifier (AKI)
                    </div>
                    <span class="font-base word-break">
                ...
                >
                    ...
                    <span
                        class="font-base"
                        v-for="(san_item, sanIndex) in uniqueSAN"
                        :key="sanIndex"
                    >
                        <RouterLink
            ...
            <div class="col-12 col-lg-6">
                <div class="bg-light-20 border-radius-sm padding-sm">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <span
                            class="font-color-light margin-bottom-xxs"
                            v-if="serial_number_decimal"
                        >
                            <div class="font-base-sb">Serial Decimal:</div>
                            <span class="font-base word-break">
                                {{ BigInt(serial_number_decimal).toString() }}
                            </span>
                        </span>
                        <span
                            class="font-color-light margin-bottom-xxs"
                            v-if="serial_number_hex"
                        >
            ...
            <div class="col-12 col-lg-6 d-flex flex-column">
                ...
                <span
                    v-if="known_compromised"
                    class="font-color-danger margin-bottom-xxs"
                    >Private Key Compromised</span
                >
                <span
                    class="font-color-light margin-bottom-xxs"
                    v-if="public_key_type"
                >
