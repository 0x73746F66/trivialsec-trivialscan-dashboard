  ...
  security_headers_config {
    ...
    content_security_policy {
      content_security_policy = join("; ", [
        ...
        "script-src-elem 'self' https://unpkg.com https://cdn.jsdelivr.net https://js.stripe.com",
        ...
        "connect-src 'self' https://trivialsec.statuspage.io wss://ws-ap4.pusher.com https://sockjs-ap4.pusher.com ${var.app_env != "Prod" ? data.terraform_remote_state.dev_lambda_api.outputs.function_url : data.terraform_remote_state.prod_lambda_api.outputs.function_url}",
      ])
      override = true
    }
  }
