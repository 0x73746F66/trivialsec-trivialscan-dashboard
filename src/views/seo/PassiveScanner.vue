...
<div class="container padding-top-xl padding-bottom-xl">
    <div class="row">
        ...
        <div class="col-lg-3 col-12 justify-content-center align-items-center d-flex flex-column feature-parra font-sm font-color-light">
          ...
          <p>Trivial Scanner reports visually highlights expired and expiring certificates so you can get to the information you want quickly, how many certificates need immediate attention, and ahow many certificates need immediate attention</p>
        </div>
          ...
          <div class="font-sm d-flex flex-column justify-content-between  font-color-primary w-100 align-items-start">
            <span class="font-color-lighter">
              ...
              <p>
                ...
                These results are presented with coresponding references, rational, and uses the MITRE ATT&CK framework to map threats to these findings.
              </p>
            </span>
          </div>
        </div>
