<template>
  <div class="d-flex flex-row align-items-center justify-content-center">
    ...
    <div>
      <button
        class="d-none d-lg-block certificate-swiper-button certificate-swiper-button-prev font-color-light"
      >
            ...
            >
              <div class="d-flex">
                ...
                <div class="d-flex flex-column">
                  <div class="margin-right-xxs font-sm-b font-color-secondary">
                  ...
                  <div class="bg-dark-40 border-radius-sm padding-sm">
                    ...
                    <div class="font-xs font-color-light margin-bottom-sm">
                      <span class="capitalize font-sm-sb">
                        ...
                        Certificate {{ issue.certificate.expiry_status }}</span
                      >
                    </div>

                    <div class="d-flex flex-column align-items-start">
                      <span class="font-color-light font-xs-sb"
                        >References</span
                      >
                      <ul>
                        <li
    ...
    <div>
      <button
        class="d-none d-lg-block certificate-swiper-button certificate-swiper-button-next font-color-light"
      >
        <IconChevron color="f0f0f0" />
      </button>
    </div>
