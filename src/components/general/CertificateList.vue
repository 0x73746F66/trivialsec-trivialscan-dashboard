                ...
                <div class="d-flex row">
                  ...
                  <div class="col-lg-4 col-12">
                    <div class="bg-dark-40 border-radius-sm padding-sm">
                          <div class="d-flex flex-column font-sm-sb font-color-light">
                          ...
                          <div class="font-sm font-color-light margin-bottom-sm">
                          ...
                          <span class="font-color-light font-sm-sb">References</span>
                          <ul>
