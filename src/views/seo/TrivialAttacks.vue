      ...
      <div class="col-12 d-flex">
        <FeatureSlider :length="3">
          <template #slide1>
            <div class="row">
              <div
                class="col-12 justify-content-center align-items-start d-flex flex-column feature-parra font-sm font-color-light"
              >
                <img
                ...
                <p>
                  ...
                  dolorem. Est laborum provident qui harum rerum quo temporibus
                  quaerat. Vel blanditiis illo qui temporibus dolorum 33 itaque
                  blanditiis et commodi error et molestiae maiores qui omnis
                  illo id ipsam repellendus. Ex consequatur assumenda non
                  laborum nisi sed voluptate illo non atque facilis aut omnis
                  fugit.
                </p>
                <p>
                  Ex explicabo omnis ab nihil rerum non deserunt modi et
      ...
      <div class="col-12 padding-top-sm margin-bottom-lg">
        ...
        >
          <span class="font-color-lighter">
            ...
            <p>
              Cum possimus vero et perspiciatis magnam qui veritatis cupiditate
              et fuga voluptatibus rem iste commodi aut iusto repellendus quo
              eligendi perspiciatis? Id dolor soluta in tempore quos et
              voluptatem nisi ea aliquid incidunt non enim magni eum dolorem
              nihil.
            </p>
          </span>
        </div>
